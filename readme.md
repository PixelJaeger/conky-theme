...
<br>
Notes:<br>
1. The whole theme was made for my Laptop with a max resolution of 1440 by 1080. So if you use it on anything "better" it's gonna be small. Workaround: use bigger text and/or add spaces between the categories.
2. For security reasons i blacked out parts of my WAN-IP and IPV6. It works nonetheless.
